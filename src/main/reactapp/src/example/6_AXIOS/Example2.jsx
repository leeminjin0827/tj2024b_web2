...
export default function Example2( props ){
    ...
    const formDataChange = (e) => {
        ...
        console.log( e.target.value ); // 'onChnage' 이벤트를 발생한 html dom 의 value 속성 값 반환
    ...
    const onPost = async ( e ) => {
        try{
            const response = await axios.post( 'http://localhost:8080/day07/react' , formData ) // state변수를 axios를 보내기
    ...
    return(<>
        <div>
            ...
            <form>
                ...
                비밀번호 : <input type="text" value={ formData.pwd } name='pwd' onChange={ formDataChange } />
