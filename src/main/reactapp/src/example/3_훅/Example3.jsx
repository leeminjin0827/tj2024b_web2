...
export default function Example3( props ){
    ...
    // (3) 리액트 방법2
    const [ image , setImage ] = useState('1.png')// 이미지를 저장하는 state변수 선언
    ...
    const 변경함수3 = ( ) => {
        ...
        setImage( image == '1.png' ? '2.jpg' : '1.png' )
    }
    ...
    return(<>
        ...
        <img onClick={ () => { setImage( image == '1.png' ? '2.jpg' : '1.png' ) } } src={ image } />
    </>)
} // c end
/*
    HTML 이벤트 함수 , onXXXX , 미리 만들어진 함수를 제공한다. , 이벤트
        [1] 종류
    ...
    함수명 : onclick/onchange vs onClick/onChange           * 차이점 : 리액트에서는 카멜표기법 사용한다.
