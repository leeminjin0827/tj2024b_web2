...
public interface StudentMapper {
    ...
    // @Select( "select * from student where kor >= 80 and math >= 80 ")
    @Select( """
            <script>
                select * from student
                where 1=1
            ...
            """ ) // java15 이상부터 (강의는17) """ """ 템플릿 지원 : 문자열 입력할때 다음줄로 이어지는 방법을
    List< Map <String ,Object > > findStudentScores( int minKor , int minMath );
            ...
            // minKor 가 80이고 minMath가 90 일때 : select * from student where 1=1 and kor >= 80 and minMath >= 90
            // minKor 가 null 이고 minMath 70일때 : select *] from student where 1=1 and minMath >= 90
    ...
    // insert into student( name , kor , math ) values ( '유재석' , 90 , 80 ) , ( '강호동' , 50 , 40 ) , ( '너구리' , 100 , 100 );
} // i end
