...
public class RestController4 {
    ...
    // -> @RequestBody 생략하면 @ModelAttribute 적용 되므로 body 매핑은 꼭 @RequestBody 작성한다
    // -> @RequestParam 도 생략하면 @ModelAttribute 적용 되지만 queryString 매핑은 @ModelAttribute 가능하므로 생략 가능하다.
    @PostMapping("/dopost1")
    // [POST] // http://localhost:8080/day02/dopost1 // { "name" : "강호동" , "age" : 10 }
    ...
    @PostMapping("/dopost2")
    // [POST] // http://localhost:8080/day02/dopost2 // { "name" : "강호동" , "age" : 10 }
