...
// - 2. Spring Controller는 기본적으로 HTTP 서블릿 지원한다. 별도로 상속을 받지 않는다.
public class RestController {

    // [1] http://localhost:8080/day01/doget
    // @RequestMapping( value = "/http주소정의" , method = RequestMethod.사용할HTTP메소드 )
    ...
    // [2] http://localhost:8080/day01/dodepost
