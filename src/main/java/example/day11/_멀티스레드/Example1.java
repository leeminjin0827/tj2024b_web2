...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        // 4. ================================= 멀티 스레드 (1) 익명 객체======================================= //
        System.out.println("=================== (익명)멀티 스레드 시작 ===================");
        ...
        // 5. ================================= 멀티 스레드 (2) 구현 객체======================================= //
        System.out.println("=================== (구현)멀티 스레드 시작 ===================");
        // 5-1 : 소리 5번 발생 , 작업스레드 정의
        비프음1 비프음1 = new 비프음1();
        Thread 비프음스레드1 = new Thread( 비프음1 );
        비프음스레드1.start();
        // 5-2 출력 5번 발생 , (위 예제 코드 복사 해오기.)
        for( int i = 1; i <= 5; i++ ){
            System.out.println("띵");
            try{ Thread.sleep( 1000 ); } catch ( Exception e ) { System.out.println( e ); }
        } // for end
        ...
        // 6. ================================= 멀티 스레드 (3) 상속 객체======================================= //
        System.out.println("=================== (상속)멀티 스레드 시작 ===================");
        // 6-1 : 소리 5번 발생 , 작업스레드 정의
        비프음2 비프음2 = new 비프음2();
        비프음2.start();
        // 6-2 출력 5번 발생 , (위 예제 코드 복사 해오기.)
        for( int i = 1; i <= 5; i++ ){
            System.out.println("띵");
            try{ Thread.sleep( 1000 ); } catch ( Exception e ) { System.out.println( e ); }
        } // for end
